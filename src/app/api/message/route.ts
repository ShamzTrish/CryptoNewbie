...
export async function POST(req: Request) {
  ...
  const readyToGoMessages: ChatGPTMessage[] = parsedMessages.map(
    (oneMessage) => ({
  ...
  //OpenAIStreamPayload is our typescript 'schema' , where I set chatGPT properties of openAI configuration
